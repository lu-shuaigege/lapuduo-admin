...
layui.use(['jquery', 'form', 'layedit', 'upload'], function () {
    ...
    $('#introduce').val(sessionStorage.getItem('introduce'));
    $('#goodCnt').val(sessionStorage.getItem('goodCnt'));
    $("#readCnt").val(sessionStorage.getItem('readCnt'));
